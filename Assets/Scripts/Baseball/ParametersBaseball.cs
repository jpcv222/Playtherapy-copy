...
public class ParametersBaseball : MonoBehaviour, IParametersManager
{
    ...
    private void Update()
    {
        ...
        sliderMinLeft.minValue = 15;
        sliderMinLeft.maxValue = 160;
        sliderLeft.minValue = sliderMinLeft.value + 25;

        if (toggleX.isOn == true)
        {
            slider_range.interactable = false;
        ...
        {
            slider_range.interactable = true;
